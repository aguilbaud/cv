...
\begin{itemize}
  \item Amélioration des performances dans le logiciel elsA (simulation d'écoulements):
    ...
    \end{itemize}
%
  \item Mise en place d'une co-simulation entre Safran et Airbus:
  \begin{itemize}%
    \item Réalisation d'une étude de faisabilité d'un couplage IP elsA/elsA;
    \item Développement d'outils nécessaires à la mise en place du couplage.\newline{}
  \end{itemize}
%
...
\begin{itemize}
  ...
  \begin{itemize}%
    \item Modernisation du code (Fortran77 vers Fortan90) et optimisations mémoire;
